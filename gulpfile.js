...
gulp.task('scripts', function() {
	return gulp.src([ // Берем все необходимые библиотеки
		'app/js/libs/jquery/dist/jquery.min.js', // Берем jQuery
		'app/js/libs/magnific-popup/dist/jquery.magnific-popup.min.js', // Берем Magnific Popup
        'app/js/common.js' // Берем свой js
		])
